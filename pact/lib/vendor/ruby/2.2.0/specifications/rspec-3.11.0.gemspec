...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rspec-core>, ["~> 3.11.0"])
      s.add_runtime_dependency(%q<rspec-expectations>, ["~> 3.11.0"])
      s.add_runtime_dependency(%q<rspec-mocks>, ["~> 3.11.0"])
    else
      s.add_dependency(%q<rspec-core>, ["~> 3.11.0"])
      s.add_dependency(%q<rspec-expectations>, ["~> 3.11.0"])
      s.add_dependency(%q<rspec-mocks>, ["~> 3.11.0"])
    end
  else
    s.add_dependency(%q<rspec-core>, ["~> 3.11.0"])
    s.add_dependency(%q<rspec-expectations>, ["~> 3.11.0"])
