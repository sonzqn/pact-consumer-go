# -*- encoding: utf-8 -*-
# stub: pact_broker-client 1.59.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2022-03-15"
  s.description = "Client for the Pact Broker. Publish, retrieve and query pacts and verification results. Manage webhooks and environments."
  s.email = ["beth@bethesque.com"]
  s.executables = ["pact-broker"]
  s.files = ["bin/pact-broker"]
  s.homepage = "https://github.com/pact-foundation/pact_broker-client.git"
  s.licenses = ["MIT"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<approvals>, ["= 0.0.24"])
      ...
      s.add_dependency(%q<approvals>, ["= 0.0.24"])
